...
"D:\IAR Systems\Embedded Workbench Evaluation 5.4\common\bin\cspybat" "D:\IAR Systems\Embedded Workbench Evaluation 5.4\avr\bin\avrproc.dll" "D:\IAR Systems\Embedded Workbench Evaluation 5.4\avr\bin\avrsim.dll"  %1 --plugin "D:\IAR Systems\Embedded Workbench Evaluation 5.4\avr\bin\<libsupport_plugin>" --backend -B "--cpu=m16a" "--enhanced_core" "-p" "D:\IAR Systems\Embedded Workbench Evaluation 5.4\avr\Config\iom16a.ddf" "--eeprom_size" "512" "-d" "sim" 
