...
#define EEPROM_SAVE_ADDR0 0x0080
#define EEPROM_SAVE_ADDR1 0x0100
...
void EEpromSaveInit()
{
   ...
   {
      EeSave1.Solo.BadSave = 0;
      MODE1.SaveData.Solo.Save1 = 1;
//      MODE1.SaveData.Solo.Save2 = 0;
//      MODE1.SaveData.Solo.Save3 = 0;
//      MODE1.SaveData.Solo.Save4 = 0;
   }
...
void EEpromTimeOut()
{
   ...
   {
      uint16 tmpCrc = MODE1.SaveData.Solo.Crc;
      uint16 tmpCrcNew = GetCRC16((uint08 *)&MODE1.SaveData, sizeof(Module_Save) - CRC_LEN);
      if (tmpCrc != tmpCrcNew)
      {
