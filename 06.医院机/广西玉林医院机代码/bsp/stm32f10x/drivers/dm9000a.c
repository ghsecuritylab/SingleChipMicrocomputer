...
static void RCC_Configuration(void)  //外设时钟
{
    /* enable gpiob port clock */
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOF | RCC_APB2Periph_USART1 | RCC_APB2Periph_GPIOE | RCC_APB2Periph_AFIO, ENABLE);
     /* enable FSMC clock */
     RCC_AHBPeriphClockCmd(RCC_AHBPeriph_FSMC, ENABLE);
}

static void NVIC_Configuration(void)  //中断
{
